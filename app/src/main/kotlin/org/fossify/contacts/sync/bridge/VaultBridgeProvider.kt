package org.fossify.contacts.sync.bridge
 ...
 * ── 谁能读 ───────────────────────────────────────────────────
 *
 * 独立的 signature 级权限 `org.fossify.permission.VAULT_BRIDGE`，
...
class VaultBridgeProvider : ContentProvider() {
    ...
    companion object {
        ...
        const val AUTHORITY = "org.fossify.contacts.vaultbridge"

        /** content://org.fossify.contacts.vaultbridge/session */
